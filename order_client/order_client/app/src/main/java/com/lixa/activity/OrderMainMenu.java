...
public class OrderMainMenu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textInfor = (TextView)findViewById(R.id.infor_text);
		...
		if(null!=str&&!"".equals(str)&&strs.length>1){
			if("昵称".equals(strs[3]))
				buf.append(strs[1]).append("\n");
			else
				buf.append(strs[3]).append("\n");
...
/*
		...
		db.close();
*/
		//NoteAdapter  nd=new NoteAdapter(this);
		//OrderAdapter od=new OrderAdapter(this);
	...
	private void setMainButtonListener() {
		...
		menu_tq.setOnClickListener(new ImageButton.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(OrderMainMenu.this, OrderWeatherXmlActivity.class);
				Bundle b = new Bundle();
